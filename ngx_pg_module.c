...
static int ngx_pg_parser_field_mod(ngx_pg_save_t *s, int32_t mod) {
...
static int ngx_pg_parser_field_format(ngx_pg_save_t *s, int16_t fmt) {
...
static int ngx_pg_parser_field_oid(ngx_pg_save_t *s, int32_t oid) {
