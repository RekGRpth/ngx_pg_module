...
%%{
    ...
    field = char %field 0 long %tableid small %columnid long %typid small %typlen long %atttypmod small %format;
    tupfield = long %data_len char %data_val;
