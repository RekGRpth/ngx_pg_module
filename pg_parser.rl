...
%%{
    ...
    action int16 { if (!parser->i) { parser->i = 2; parser->int16 = 0; } parser->int16 |= *p << ((2 << 2) * --parser->i); }
    action int32 { if (!parser->i) { parser->i = 4; parser->int32 = 0; } parser->int32 |= *p << ((2 << 2) * --parser->i); }
