...
%%{
    ...
    action rowval { if (!parser->nbytes) { if (str && settings->rowval(parser->data, p - str, str)) fbreak; str = NULL; parser->str = 0; if (parser->nrows) fhold; } }
    ...
    | 68 int4 @row int2 @nrows ( row >when rowend @rowval @/rowval )**
