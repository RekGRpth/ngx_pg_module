...
%%{
    ...
    action function_result_len { parser->result_len = parser->int4; if (settings->result_len(parser->data, parser->result_len)) fbreak; if (!parser->result_len || parser->result_len == (uint32_t)-1) fnext function_result; }
    action result_valeof { if (str && settings->result_val(parser->data, p - str, str)) fbreak; str = NULL; parser->str = 0; }
    action function_result_valeof { if (str && settings->result_val(parser->data, p - str, str)) fbreak; str = NULL; parser->str = 0; }
    ...
    action function_result_val { if (!parser->result_len--) { if (str && settings->result_val(parser->data, p - str, str)) fbreak; str = NULL; parser->str = 0; fhold; if (!--parser->result_count) fnext main; else fnext function_result; } }
    ...
    function_byte = any @str @function_result_val @/function_result_valeof;
    ...
    function_result = int4 @function_result_len function_byte **;
    ...
    | 86 int4 @function function_result **
    | 90 int4 @ready ready
    ) ** $all;
